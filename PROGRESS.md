...
- [x] **Quick Add UX Refinements & Recurring Accrued Income Automation**:
  - เปลี่ยนชื่อหัวข้อเป็น **"บันทึกด่วน" (Quick Add)** ตัดคำว่า "3 taps" / "3 แตะ" ออกทั้งหมดตามคำแนะนำ
  - นำแป้นตัวเลขบนหน้าจอ (Numpad) ออก คืนพื้นที่แนวตั้ง ~180px ให้หน้าจอโปร่ง โล่ง สบายตาในสไตล์ Quiet Luxury
  - ปรับช่องจำนวนเงินเป็น `TextField` ตัวเลขขนาดใหญ่ 32px พร้อมสัญลักษณ์สกุลเงินด้านหน้า รองรับทั้งคีย์บอร์ดมาตรฐานบนมือถือและคีย์บอร์ดคอมพิวเตอร์
  - เพิ่มระยะห่างระหว่างกรอบ (Spacing 12–14px) และขนาดความสูงปุ่ม/กล่องข้อความ (46–48px) กดง่าย ไม่เบียดกัน
  - แก้ไข Dropdown โครงการพิเศษ โดยย้ายชื่อ "โครงการพิเศษ (Special Project)" มาไว้ด้านบน ไม่ถูกเมนูกดเลือกบดบังอีกต่อไป
  - เพิ่มระบบอัตโนมัติสำหรับรอบเดือนทำงานในรายการประจำ (Recurring Work Period Automation):
    - เลือกรอบเดือนทำงานได้ทั้ง **"เดือนก่อนหน้า (N - 1)"** (เช่น ค่าเวร, ค่าตอบแทนพิเศษ ทำงานเดือนก่อน ได้เงินเดือนนี้) และ **"เดือนเดียวกัน"** (เช่น เงินเดือนประจำ)
    - ระบบอัตโนมัติคำนวณเดือนทำงานให้อัตโนมัติเมื่อถึงรอบกำหนด (รองรับการข้ามปี มกราคม -> ธันวาคมปีก่อนหน้า 100%)
    - บันทึกรายการค้างรับอัตโนมัติ (`is_cleared = false`) เข้า Accrued Income Tracker เพื่อรอผู้ใช้กด Mark Received เมื่อเงินเข้าจริง พร้อมแนบประเภทภาษีที่ถูกต้อง
    - เพิ่ม Unit Tests รองรับครอบคลุม 100% ผ่านทุกแบบทดสอบ (136/136 tests passed)
